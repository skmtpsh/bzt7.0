    ...
    <scroll class="detaitxt"> 
      ...
      <div class="footer">
        <div class="index-footer">
          <span class="fav" @click="doFav">
            <i class="iconfont icon-favorites"></i>
          </span>
          <a href="javascript:;" class="index-footertab" @click="readPDF" :class="{bgred: !!isFile}">
            <span class="index-txt">PDF阅读</span>
          </a>
          <a href="javascript:;" class="index-footertab" v-show="!isStruct">
...
export default {
  ...
  created () {
    ...
    this.isFile = parseInt(this.detail.Isfile) || parseInt(this.detail.JSON_Isfile)
    this.isStruct = parseInt(this.detail.Isstruct) || parseInt(this.detail.JSON_Isstruct)
    this.std_file = this.detail.std_file || this.detail.JSON_std_file

    this._getDetail()
  },
  methods: {
    _getDetail () {
      // let tempFileID = this.detail.fileid || this.detail.JSON_fileid
